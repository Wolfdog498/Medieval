...
VALUES	('UNIT_ZWEIHANDER',			2,			195,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_ZWEIHANDER_NAME',			'LOC_UNIT_ZWEIHANDER_DESCRIPTION',			'YIELD_GOLD',	null,								'PROMOTION_CLASS_MELEE',			3,				48,		0,				0,		0,			'RESOURCE_IRON',		'TECH_MILITARY_ENGINEERING',	'TECH_GUNPOWDER',				'0',			0,				0,			'0',			'0',		null,				'1',		'0'),
		...
		--('UNIT_STRADIOT',			5,			250,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_STRADIOT_NAME',			'LOC_UNIT_STRADIOT_DESCRIPTION',			'YIELD_GOLD',	null,								'PROMOTION_CLASS_LIGHT_CAVALRY',	3,				52,		0,				0,		0,			'RESOURCE_HORSES',		'TECH_METAL_CASTING',			'TECH_MILITARY_SCIENCE',		'0',			0,				0,			'0',			'0',		null,				'1',		'0'),
...
UPDATE Units SET Combat = 52 WHERE UnitType = 'UNIT_KNIGHT';
...
VALUES	('UNIT_ZWEIHANDER',			'UNIT_MUSKETMAN'),
		...
		('UNIT_CONDOTIERRE',		'UNIT_HARQUEBUSIER'), -- delete when adding UNIT_STRADIOT
